...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_owner_type_rating", "owners", ["owner_type", "rating"], unique=False
    )
    op.create_index(
        op.f("ix_owners_owner_type"), "owners", ["owner_type"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["owner_id"],
            ["owners.id"],
            name=op.f("listings_owner_id_fkey"),
            ondelete="SET NULL",
        ),
        sa.ForeignKeyConstraint(
            ["source_id"],
            ["sources.id"],
            name=op.f("listings_source_id_fkey"),
            ondelete="RESTRICT",
        ),
    ...
    op.create_index(
        "ix_listing_city_price",
        "listings",
        ["address_city", "price_amount"],
        unique=False,
    )
    op.create_index(
        "ix_listing_fingerprint_status",
        "listings",
        ["fingerprint", "status"],
        unique=False,
    )
    op.create_index(
        "ix_listing_status_updated", "listings", ["status", "updated_at"], unique=False
    )
    op.create_index(
        op.f("ix_listings_address_city"), "listings", ["address_city"], unique=False
    )
    op.create_index(
        op.f("ix_listings_fingerprint"), "listings", ["fingerprint"], unique=False
    )
    op.create_index(
        op.f("ix_listings_first_seen_at"), "listings", ["first_seen_at"], unique=False
    )
    op.create_index(
        op.f("ix_listings_last_seen_at"), "listings", ["last_seen_at"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["source_id"],
            ["sources.id"],
            name=op.f("raw_listings_source_id_fkey"),
            ondelete="RESTRICT",
        ),
    ...
    op.create_index(
        op.f("ix_raw_listings_fetched_at"), "raw_listings", ["fetched_at"], unique=False
    )
    op.create_index(
        op.f("ix_raw_listings_processing_status"),
        "raw_listings",
        ["processing_status"],
        unique=False,
    )
    op.create_index(
        "ix_raw_status_fetched",
        "raw_listings",
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["listing_id"],
            ["listings.id"],
            name=op.f("listing_photos_listing_id_fkey"),
            ondelete="CASCADE",
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["listing_id"],
            ["listings.id"],
            name=op.f("listing_price_history_listing_id_fkey"),
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("listing_price_history_pkey")),
    )
    op.create_index(
        op.f("ix_listing_price_history_recorded_at"),
        "listing_price_history",
        ["recorded_at"],
        unique=False,
    )
    op.create_index(
        "ix_price_history_listing_date",
        "listing_price_history",
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_listing_price_history_recorded_at"), table_name="listing_price_history"
    )
